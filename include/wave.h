...
namespace wave {
    ...
    public:
        ...
        Wave(int16_t nChannels, int32_t nSamplesPerSec,
        ...
        void get_samples(unsigned int offset, unsigned int size,
        ...
        void append_samples(const std::vector<char>& samples_l,
                            const std::vector<char>& samples_r);

        void
        append_samples(const char* samples_l, const char* samples_r, int size);
